...
lll:="" ; very important for debugging
msg:=""  . A_ScriptName . ">" . A_LineNumber . " (greetings from init script)"
lll:=msg . "`n" . A_AhkVersion . " = A_AhkVersion `n`n"
...
#Include ScriptNameLetterIcon.inc.ahk
...
;~ #Include UPDATEDSCRIPT_global.inc.ahk ; do temporary comment it.
;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
